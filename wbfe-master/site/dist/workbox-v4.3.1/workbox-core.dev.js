...
this.workbox.core = (function (exports) {
  ...
  */
  const messages = {
    ...
    "incorrect-class": ({ expectedClass, paramName, moduleName, className, funcName, isReturnValueProblem }) => {
      ...
      return (
        `The parameter '${paramName}' passed into ` + `'${moduleName}.${className ? className + "." : ""}${funcName}()' ` + `must be an instance of class ${expectedClass.name}.`
      );
    },
  ...
  */
  ...
  const isInstance = (object, expectedClass, { moduleName, className, funcName, paramName, isReturnValueProblem }) => {
  ...
  */
  /**
   * Force a service worker to Join thective, instead of waiting. This is
